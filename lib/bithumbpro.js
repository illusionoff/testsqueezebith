const fs = require("fs");
const { reconnectTimeMessageClosure, changeTradeArr, diffMaxIndexS, timeStopTestClosure, consoleLogGroup, squeeze, timerClosure, funStartPing } = require('../functions/functions');
...
function wsStartBith(cmd, args) {
  ...
  let timerConfigObj = { period: TIMER_PING, funStart: funStartPing, funEnd: funEndPing };
