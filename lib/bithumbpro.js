const fs = require("fs");
const { reconnectTimeMessageClosure, changeTradeArr, diffMaxIndexS, timeStopTestClosure, consoleLogGroup, squeeze, timerClosure, funStartPing, funEndPing } = require('../functions/functions');
